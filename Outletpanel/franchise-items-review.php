...
<head>
    ...
    <title>Outlet Panel - Item Reviews</title>
</head>
<body>
    <div class="sidebar">
        <div class="logo">
        ...
        <div class="main--content">
            <div class="header--wrapper">
                <div class="header--title">
                    ...
                    <h2>Outlet Panel - Item Reviews</h2>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <?php
                                $uid = $_SESSION['id'];
                                $query = "SELECT ir.*, i.name AS iname, f.name AS fname, u.username AS uname FROM `item_review` ir, `items` i, `franchise` f, `user` u WHERE ir.user_id = u.id AND ir.item_id = i.id AND i.franchise_id = f.id AND f.user_id = $uid";
                                    ...
                                    foreach($query_run as $row) 
                                    {
                                        ?>
                                            <tr>
                                                ...
                                                <td><?= $row['uname'] ?></td>
                                                <td><?= $row['order_id'] ?></td>                                            
                                                <td><a href="franchise-item-coupon.php?id=<?= $row['id'] ?>" class="btn btn-danger">Provide Coupon</a></td>
                                            </tr>
                                        <?php
                                    }
                                }
