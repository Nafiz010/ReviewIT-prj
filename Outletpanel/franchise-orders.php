...
<head>
    ...
    <title>Outlet Panel - Orders</title>
</head>
<body>
    <div class="sidebar">
        <div class="logo">
        ...
        <div class="main--content">
            <div class="header--wrapper">
                <div class="header--title">
                    ...
                    <h2>Outlet Panel - User Orders</h2>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <?php
                                $uid = $_SESSION['id'];
                                $query = "SELECT o.id, o.quantity, o.price, f.name AS fname, i.name AS iname, u.username AS uname, u.phone AS uphone, u.address AS uaddress FROM `order` o, `items` i, `franchise` f, `user` u WHERE i.id = o.item_id AND f.id = i.franchise_id AND f.user_id = $uid AND u.id = o.user_id";
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="../inc/server.php" method="POST">
                                                        <button type="submit" name="f_order_delete" value="<?=$row['id'] ?>" class="btn btn-danger">Delete</button>
                                                    </form>
                                                </td>
                                            </tr>
                                        <?php
