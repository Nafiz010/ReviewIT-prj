...
<head>
    ...
    <title>Admin Panel - Outlets</title>
</head>
<body>
    <div class="sidebar">
        <div class="logo">
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4>Registered Outlets
                            <a href="outlet-add.php" class="btn btn-dark float-end">Add Outlets</a>
                        </h4>
                    </div>
                    <div class="card-body">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <?php
                                $query = "SELECT f.*, u.username AS uname FROM franchise f, `user` u WHERE u.id = f.user_id ORDER BY f.id";
                                    ...
                                    foreach($query_run as $row) 
                                    {
                                        ?>
                                            <tr>
                                                ...
                                                <td><?= $row['uname'] ?></td>
                                                <td><a href="outlet-edit.php?id=<?= $row['id'] ?>" class="btn btn-dark">Edit</a></td>
                                                <td>
                                                    <form action="../inc/server.php" method="POST">
                                                        <button type="submit" name="outlet_delete" value="<?=$row['id'] ?>" class="btn btn-danger">Delete</button>
                                                    </form>
                                                </td>
                                            </tr>
                                        <?php
