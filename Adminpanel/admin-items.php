                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <?php
                                $query = "SELECT i.*, f.name AS fname FROM items i, franchise f WHERE f.id = i.franchise_id ORDER BY i.id";
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="../inc/server.php" method="POST">
                                                        <button type="submit" name="items_delete" value="<?=$row['id'] ?>" class="btn btn-danger">Delete</button>
                                                    </form>
                                                </td>
                                            </tr>
                                        <?php
