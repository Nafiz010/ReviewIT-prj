...
<head>
    ...
    <title>Admin Panel - Outlet Reviews</title>
</head>
<body>
    <div class="sidebar">
        <div class="logo">
        ...
        <div class="main--content">
            <div class="header--wrapper">
                <div class="header--title">
                    ...
                    <h2>Admin Panel - Outlet Reviews</h2>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <?php
                                $query = "SELECT fr.id, fr.rating_number, fr.comments, f.name AS fname, u.username AS uname, pr.franchise_review FROM `franchise_review` fr, `franchise` f, `user` u, `pending_review` pr WHERE f.id = fr.franchise_id AND u.id = fr.user_id AND pr.franchise_review=fr.id AND Approval= 'Approved' ORDER BY fr.id";
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="../inc/server.php" method="POST">
                                                        <button type="submit" name="outlet_review_delete" value="<?=$row['id'] ?>" class="btn btn-danger">Delete</button>
                                                    </form>
                                                </td>
                                            </tr>
                                        <?php
